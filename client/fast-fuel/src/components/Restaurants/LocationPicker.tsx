    ...
    <div style={{ height: 320 }}>
      <MapContainer center={position} zoom={13} style={{ height: '100%', width: '100%' }}>
        ...
        <Marker
          ...
          draggable
          ref={(ref) => {
            // react-leaflet gives access to the underlying Leaflet marker instance via the ref
            // `ref` can be a Marker instance or null; we cast through unknown to L.Marker
            setMarkerInstance(ref as unknown as L.Marker | null);
          }}
        />
      </MapContainer>
    </div>
