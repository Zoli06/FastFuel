...
import type { NumericComboboxItem, NumericComboboxItemGroup } from './types.ts';
...
export const NumericSelect = ({
  ...
  const valueStr = value !== undefined && value !== null ? value.toString() : undefined;
  ...
  return (
    <Select
      data={selectData}
      {...(valueStr !== undefined ? { value: valueStr } : {})}
      {...(defaultValueStr !== undefined ? { defaultValue: defaultValueStr } : {})}
